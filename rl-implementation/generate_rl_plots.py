...
BASE = 'results/scenarios/RL-Baseline'
OUT = 'plots/scenarios/RL-Baseline'
...
try:
    ...
    plt.title('RL-Baseline: Avg Residual Energy per Round')
    plt.grid(True)
    plt.tight_layout()
...
try:
    ...
    plt.title('RL-Baseline: PDR per Round')
    plt.ylim(0,1)
    plt.grid(True)
    plt.tight_layout()
...
try:
    ...
    plt.title('RL-Baseline: Throughput over Time')
    plt.grid(True)
    plt.tight_layout()
...
try:
    ...
    plt.xlabel('Round')
    plt.ylabel('Nodes')
    plt.title('RL-Baseline: Alive and Dead Nodes')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
...
try:
    ...
    plt.title('RL-Baseline: End-to-End Delay Distribution')
    plt.grid(True)
    plt.tight_layout()
...
try:
    ...
    plt.title('RL-Baseline: Control Overhead Ratio per Round')
    plt.ylim(0,1)
    plt.grid(True)
    plt.tight_layout()
    ...
    plt.xlabel('Round')
    plt.ylabel('Number of Packets')
    plt.title('RL-Baseline: Control and Data Packets per Round')
    plt.legend()
    plt.grid(True)
    plt.tight_layout()
